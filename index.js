...
const uri = "mongodb+srv://ToyManager:sPKiCJn7qmfktQvf@cluster0.xpliwro.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    app.get('/toys', async (req, res) => {
      ...
      const result = await toyCollection.find(query).sort(sortOrder).limit(20).toArray();
      res.send(result);
    })
